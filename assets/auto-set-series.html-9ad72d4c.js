import{_ as n,p as s,q as e,$ as a}from"./framework-c873e247.js";const i={},t=a(`<h2 id="introduction" tabindex="-1"><a class="header-anchor" href="#introduction" aria-hidden="true">#</a> Introduction</h2><p>In order to save users&#39; time cost, the theme can automatically generate a series of configurations for the documents under the <code>docs</code> folder according to the folder nesting relationship.</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>/
└─ .vuepress
└─ docs
  └─ sery 1
    └─ doc1.md
