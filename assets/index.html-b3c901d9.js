import{_ as e,p as n,q as s,$ as a}from"./framework-c873e247.js";const i={},t=a(`<h2 id="quick-start" tabindex="-1"><a class="header-anchor" href="#quick-start" aria-hidden="true">#</a> Quick Start</h2><p><strong>npx</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># Init，and choose 2.x</span>
...
theme-cli init
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7),c=[t];function d(l,r){return n(),s("div",null,c)}const p=e(i,[["render",d],["__file","index.html.vue"]]);export{p as default};
